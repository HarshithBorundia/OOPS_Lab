public class FDRoboMusic extends FDStudent implements RoboticsClubMember, MusicClubMember{
    private int musicClubRank;
    private int roboClubRank;
    private String[] robotTypes;
    private String[] instrumentTypes;
    public FDRoboMusic(String n, String i, Major m, String sfp, String std, int mr, int rr, String[] l,String ... t){
        super(n,i,m,sfp,std);
